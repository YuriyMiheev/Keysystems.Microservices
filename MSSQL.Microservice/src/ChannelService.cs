...
namespace MSSQL.Microservice
{
	...
	public class ChannelService : IChannelService//, IDisposable
	{
		...
		#region Ctor
		public ChannelService(IAppSettingsConfig appConfig, IChannelControl control, ILogger logger, ChannelStatus status, IMessageReceiver receiver)
		{
