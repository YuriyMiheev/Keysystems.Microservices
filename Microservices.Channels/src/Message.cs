...
namespace Microservices.Channels
{
	...
	public class Message// : MarshalByRefObject
	{
		...
		public MessageProperty[] Properties
		{
			...
			internal set { properties = (value ?? new MessageProperty[0]).ToList(); }
		}
		...
		public MessageContentInfo[] Contents
		{
			...
			internal set { contents = (value ?? new MessageContentInfo[0]).ToList(); }
		}
		...
		{
			get { return status; }
			internal set { status = (value ?? new MessageStatus()); }
		}
		...
		public MessageStatus PrevStatus
		{
			...
			internal set { prevStatus = (value ?? new MessageStatus()); }
		}
		#endregion
