...
namespace Microservices.Channels.MSSQL.Data
{
	...
	/// </summary>
	public class ChannelDataAdapter : MessageDataAdapterBase, IChannelDataAdapter
	{

		#region Ctor
		public ChannelDataAdapter(IDatabase database)
			: base(database)
		{ }
		...
		public ChannelDataAdapter(DbContext dbContext)
			: base(dbContext)
		{ }
		#endregion
